...
public class LambdaTest1 {
    ...
    public void test2() {
        ...
        con.accept("语法格式二：Lambda 需要一个参数，但是没有返回值。");

        System.out.println("*******************");
        //如果只有一段实现代码,{}也可以不要
        Consumer<String> con1 = (String s) -> System.out.println(s);
        con1.accept("语法格式二：Lambda 需要一个参数，但是没有返回值。");
    ...
    public void test3() {
        ...
        con1.accept("语法格式三：数据类型可以省略，因为可由编译器推断得出，称为“类型推断”");

        System.out.println("*******************");

        Consumer<String> con2 = System.out::println;
        con2.accept("语法格式三：数据类型可以省略，因为可由编译器推断得出，称为“类型推断”");
